...
public class ClsMesasActivas {
    ...
    public ClsMesasActivas(String id_mesa, String entrada_minima, String modalidad, String ciegaMinima, String ciegaMaxima, String usuariosActivos, String cantidadUsuarios) {
