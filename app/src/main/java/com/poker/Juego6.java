...
public class Juego6 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    LinearLayout usuario1, usuario2, usuario3, usuario4, usuario5, usuario6, usuario7, usuario8, usuario9,Usuarioextra, mesa_fondo, fondo;
    TextView us1, us2, us3, us4, us5, us6, cron, tvId_mesa, tvCiegaMinima, tvCiegaMaxima;
    ImageView img1,img2,img3,img4,img5,img6;
    LinearLayout btnuser1, btnuser2, btnuser3, btnuser4, btnuser5, btnuser6, cajaUser1;
    ConstraintLayout cajaPerfilUser1;
    public static ProgressBar barra ;
    public static  int tipo_mesa=0;
    public static String[] IdJug = new String[6];
    public static int OrdenJug=0;
    public static String [] NomJug = new String [6];
    public static int [] PuestJug = new int [6];
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        cajaUser1 = (LinearLayout) findViewById(R.id.CajaUss1Juego6);
        cajaPerfilUser1 = (ConstraintLayout) findViewById(R.id.CajaPerfil1Juego6);
        us1 = (TextView) findViewById(R.id.tvNombre1Juego6);
        us2 = (TextView) findViewById(R.id.tvNombre2Juego6);
        us3 = (TextView) findViewById(R.id.tvNombre3Juego6);
        us4 = (TextView) findViewById(R.id.tvNombre4Juego6);
        us5 = (TextView) findViewById(R.id.tvNombre5Juego6);
        us6 = (TextView) findViewById(R.id.tvNombre6Juego6);
        btnuser1 = (LinearLayout) findViewById(R.id.linPosicion1Juego6);
        btnuser2 = (LinearLayout) findViewById(R.id.linPosicion2Juego6);
        btnuser3 = (LinearLayout) findViewById(R.id.linPosicion3Juego6);
        btnuser4 = (LinearLayout) findViewById(R.id.linPosicion4Juego6);
        btnuser5 = (LinearLayout) findViewById(R.id.linPosicion5Juego6);
        btnuser6 = (LinearLayout) findViewById(R.id.linPosicion6Juego6);
        usuario1 = (LinearLayout) findViewById(R.id.lilUsuario1Juego6);
        usuario2 = (LinearLayout) findViewById(R.id.lilUsuario2Juego6);
        usuario3 = (LinearLayout) findViewById(R.id.lilUsuario3Juego6);
        usuario4 = (LinearLayout) findViewById(R.id.lilUsuario4Juego6);
        usuario5 = (LinearLayout) findViewById(R.id.lilUsuario5Juego6);
        usuario6 = (LinearLayout) findViewById(R.id.lilUsuario6Juego6);
...
//----------------------------------------------------------------------------------------------------------------------------------------------
    ...
    public void Posicion1(View view) {
        ...
        Thread tr = new Thread() {
            @Override
            public void run() {
                final String result1 = CrearMano(getIntent().getStringExtra("id_mesa_card"));
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
